...
We have achieved a basic **signal-based** reactive system. But now we could make it
easier to use, so that we don't have to manually create elements and update their
values imperatively, but rather *declaratively*, as most frameworks do. Let's use
