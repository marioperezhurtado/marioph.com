...
Don't get me wrong, UI component frameworks can be [amazing](https://ui.shadcn.com/).
...
**You don't really need to.** If you already know CSS, you just have to start styling, looking up the utility classes you need to use, in a [cheatsheet](https://nerdcave.com/Tailwind-cheat-sheet).
